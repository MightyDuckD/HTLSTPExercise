\chapter{Moderne Steganographie}
	...
	In dem nachfolgenden Kapitel werden einige dieser Verfahren erklärt und etwaige Fehler und Schwierigkeiten, die damit verbunden sind, aufgezeigt. Außerdem werden einige Implementierungen vorgestellt, verglichen und auf die Verwendbarkeit im Alltag getestet. 
...
%	\end{table}
	...
	Gesucht wird die größte Steigung zwischen zwei Punkten. Also $ d(j) - d(i) , i > j $ soll maximiert werden. Dazu wurde folgender sehr einfacher und schneller Algorithmus gewählt:
