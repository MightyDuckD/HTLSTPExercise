...
%	\end{table}
	...
	Die bekannte Steganographie App hat eine Variante des LSB-Verfahren implementiert. Zusätzlich unterstützt sie auch noch die Verwendung eines Passwort zum schützen des Inhalt. 
	Es gibt sowohl Vorteile als auch Nachteile bei dieser Implementierung. Der Vorteil ist: Jeder kann sich die App herunterladen und verwenden, ohne viel über Programmieren und Kryptographie wissen zu müssen. Außerdem ist das Verfahren standardisiert, wodurch sich keine Probleme bei Fehlimplementierungen ergeben kann. Der große Nachteil ist die Tatsache das dieses Programm sehr bekannt ist und wenn jemand vermutet das sich in einem Bild versteckte Informationen befinden, wird er als erstes Verfahren OpenStego überprüfen.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.13]{images/L-earth.png}
		\includegraphics[scale=0.4]{images/L-barcode-example.png}
	...
	\begin{figure}[H]
		...
		\caption[Text Stereogramm]{Beispiel für ein Text Stereogramm}
	...
	\begin{figure}[H]
		...
		\caption[Objekt-Array Stereogramm]{Beispiel für ein Objekt-Array Stereogramm}
	...
	\begin{figure}[H]
		...
		\caption[Kernel Beispiel]{Kernel wird auf den Input angewendet um den Output zu erzeugen.}
