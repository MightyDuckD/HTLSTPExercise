\section{Klassiche Verfahren der Steganographie}
	...
	Das nachfolgenden Kapitel soll mit praxisnahen Beispielen einen Überblick darüber verschaffen, was genau der Grundgedanke von Steganographie ist.
	

	\subsection{Spreu und Weizen Verfahren}
	
	Das Spreu und Weizen-Verfahren\footnote{eng.: Chaffing and Winnowing} stellt eine Mischform zwischen Steganographie und Kryptographie da und können daher nicht wirklich eindeutig zugeordnet werden. Trotzdem enthält es sehr viele Elemente der Steganographie und eignet sich gut als Einstieg in diesen Thema. Die Idee des Verfahrens ist es, die zu versteckenden Daten in einem Haufen nicht-relevanter Information zu verstecken, wie die Nadel im Heuhaufen. 
...
\begin{figure}[H]
	...
	\caption[Morsecode in Bild Beispiel 1]{Hier wurde mit den Grashalmen links von der Brücke, auf der kleinen Mauer und entlang des Wasser Morsecode hinzugefügt}
