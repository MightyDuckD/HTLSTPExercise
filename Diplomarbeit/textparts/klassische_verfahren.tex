...
Eine einfache Variante für klassische Steganographie in Bildern ist das kodieren von Text in Form von Morsecode oder ähnlichem. Dieser kann zum Beispiel in der Länge von Grashalmen auf einem gemalten Bild kodiert sein, wie es in dem bekannten Beispiel \ref{fig:L: Stego Example} gemacht wurde.
...
\begin{figure}[H]
	...
	\caption{Hier wurde mit den Grashalmen links von der Brücke, auf der kleinen Mauer und entlang des Wasser Morsecode hinzugefügt}
...
\begin{figure}[H]
	...
	\caption{Wenn das grüne Band zum dekodieren verwendet wird ergibt sich die Nachricht ''Renseignements arrivent'', auf Deutsch: ''Informationen angekommen''}
...
\caption{In diesem Beispiel wurde Morsecode in Form der Größe der Vögel, der Zaunstangen und der Blumen kodiert. Dekodiert ergeben sich die Namen der drei Automarken VW, Buick und Volvo }
