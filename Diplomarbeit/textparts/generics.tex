...
\subsection{Was sind Generische Datentypen?}
			...
			Die grundlegende Funktion generischer Datentypen lässt sich am besten mittels eines Beispiels erklären: Angenommen man würde eine einfache Klasse implementieren wollen, welche einen String kapselt. Diese Klasse könnte cirka so aussehen:

\begin{lstlisting}[caption=Kapselung eines Strings,label=lst:generics:stringwrapper]
...
public class StringWrapper
{
	...
	public String getValue()
	{
		return this.value;
			...
			\begin{lstlisting}[caption=Kapselung eines Integers,label=lst:generics:integerwrapper]
...
Dieses Vorgehen würde aber zur Laufzeit des Programmes zu einer \emph{ClassCastException} in Zeile 3 führen, da ein Double Objekt nicht zu einem Integer Objekt gecastet werden kann.
...
\subsubsection{Parametrisierte Typen}
Ein Bild, das nicht zum Thema passt.	
\begin{figure}[H]
	\centering
		\includegraphics[scale=0.20]{images/Norwegen_04_116.jpg}
...
\begin{figure}[H]
	\centering
		\includegraphics{images/HTL_IF.png}
	\caption{Informatik - Logo}
	\label{fig:edvo-logo}
\end{figure}
...
Hier wird eine andere PDF eingefügt
